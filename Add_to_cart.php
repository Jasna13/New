...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <!-- Form to proceed to checkout with specific product -->
            <form action="buynow_cart.php" method="GET">
                <input type="hidden" name="cart_id" value="<?php echo htmlspecialchars($row['cid']); ?>">
                ...
                <input type="hidden" name="total" value="<?php echo htmlspecialchars($row['total']); ?>">
