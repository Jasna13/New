      ...
      <div class="navbar">
          ...
          <nav>
              <ul>
                  ...
                  <?php else: ?>
                      <li><a href="http://localhost/MINI%20PROJECT/Login/login.php">Login</a></li>
                  <?php endif; ?>
              </ul>
          </nav>
      </div>
...
document.getElementById("searchForm").addEventListener("submit", function(event) {
        ...
        if (data.length > 0) {
            data.forEach(product => {
                ...
                productCard.innerHTML = `
                    ...
                    <p><span class='original-price'>₹${product.original_price}</span> ₹${product.discounted_price}</p>
    ...
    .catch(error => {
        ...
        const searchResultsDiv = document.getElementById("searchResults");
        searchResultsDiv.innerHTML = "<p>There was an error processing your request.</p>";
    });
});
</script>
